...
To install keep-balance, follow the instructions https://doc.arvados.org/install/install-keep-balance.html[here]. This page also contains the configuration details for keepstore.
